...
const deliveryStages = [
  { title: "Discover", steps: ["Product Opportunity", "Selection", "Pricing"], image: "/images/industry/home-industry-products-2025.jpg", alt: "Cleaning products being evaluated for market opportunity" },
  { title: "Develop", steps: ["Paid Samples", "OEM/ODM", "Production"], image: "/images/industry/sourcing-product-components-2025.jpg", alt: "Cleaning product components for OEM and ODM development" },
  { title: "Deliver", steps: ["Quality & Compliance", "Export & Delivery", "After-Sales"], image: "/images/industry/expo-booth-cleaning-suppliers-2026.jpg", alt: "Cleaning industry supplier products ready for commercial delivery" }
];
    ...
    <div className="sourcing-opportunity-page">
      ...
      <section className="sourcing-opportunity-section sourcing-opportunity-market">
        <div className="sourcing-opportunity-shell">
          ...
          <div className="sourcing-opportunity-market-story"><div className="sourcing-opportunity-market-number"><div><small>Today</small><strong>Approx. USD 40B+</strong></div><span aria-hidden="true">→</span><div><small>Over The Next Decade</small><strong>Toward USD 140B</strong></div></div><figure className="sourcing-opportunity-market-visual"><img src="/images/industry/home-industry-products-2025.jpg" alt="Emerging cleaning product categories at an industry product showcase" /><figcaption>Product categories are expanding faster than traditional sourcing cycles.</figcaption></figure></div>
