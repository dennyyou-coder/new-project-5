...
const deliveryStages = [
  { title: "Discover", steps: ["Product Opportunity", "Selection", "Pricing"], image: "/images/site-refresh/system/product-selection.webp", alt: "Cleaning products being evaluated for market opportunity" },
  { title: "Develop", steps: ["Paid Samples", "OEM/ODM", "Production"], image: "/images/site-refresh/system/product-engineering.webp", alt: "Cleaning product engineering and development" },
  { title: "Deliver", steps: ["Quality & Compliance", "Export & Delivery", "After-Sales"], image: "/images/site-refresh/system/smart-factory.webp", alt: "Modern cleaning equipment production and quality control" }
];
    ...
    <div className="sourcing-opportunity-page">
      <section className="sourcing-opportunity-hero">
        <div className="sourcing-opportunity-shell sourcing-opportunity-hero-grid">
          ...
          <figure className="sourcing-opportunity-hero-proof">
            <img src="/images/site-refresh/system/product-engineering.webp" alt="Cleaning product opportunity engineering review" />
      ...
      <section className="sourcing-opportunity-section sourcing-opportunity-market">
        <div className="sourcing-opportunity-shell">
          ...
          <div className="sourcing-opportunity-market-story"><div className="sourcing-opportunity-market-number"><div><small>Today</small><strong>Approx. USD 40B+</strong></div><span aria-hidden="true">→</span><div><small>Over The Next Decade</small><strong>Toward USD 140B</strong></div></div><figure className="sourcing-opportunity-market-visual"><img src="/images/site-refresh/system/product-selection.webp" alt="Premium cleaning equipment selected for market evaluation" /><figcaption>Product categories are expanding faster than traditional sourcing cycles.</figcaption></figure></div>
      ...
      <section className="sourcing-opportunity-section sourcing-opportunity-denny-method">
        <div className="sourcing-opportunity-shell sourcing-opportunity-method-grid">
          ...
          <figure><img src="/images/site-refresh/system/market-intelligence.webp" alt="Cleaning industry market intelligence and product analysis" /><figcaption>Early Signals → Market Judgment → Product Direction → Supply Chain Execution</figcaption></figure>
        </div>
      </section>
