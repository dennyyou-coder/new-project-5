...
export const ANALYSIS_COMPANY_KEYWORDS = [
  ...
  keyword("Greenworks", "greenworks", ["greenworks"]),
  ...
  keyword("Navimow", "navimow-segway", ["navimow", "segway"]),
  ...
  keyword("RockMow", "rockmow", ["rockmow"]),
  ...
  keyword("Sunseeker", "sunseeker", ["sunseeker", "sunseekers"]),
