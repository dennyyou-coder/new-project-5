  ...
  return (
    <section className="section sourcing-selector-section" id="product-options">
      <div className="sourcing-v3-container">
        ...
        <h2>Explore six robotic mower product directions.</h2>
        <p className="sourcing-selector-disclaimer">Illustrative product directions. Final supplier models and specifications are verified against your brief.</p>
