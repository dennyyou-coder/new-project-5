...
6. **Can it provide real deployment cases or facility testing results?**  
   Demo videos are not enough. Ask for deployment experience by facility type if available.

7. **Can it provide test data for cleaning coverage, runtime, water recovery, obstacle avoidance, and safety behavior?**  
   Ask for test methods, not only claims.

8. **Can it support operator training, maintenance, and spare parts?**  
...
11. **Can it scale production and service support without quality drops?**  
