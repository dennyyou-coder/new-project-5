---
title: "How to Find a Break in a Robot Mower Boundary Wire"
description: "Find and repair a robot mower boundary wire break. Check power, connectors and splices, narrow the fault, use approved couplers and retest."
date: "2026-07-21"
...
## How to Find a Robot Mower Boundary Wire Break: Quick Steps

1. Record the exact mower error, station light and recent landscaping, edging or weather event before moving any connector.
2. Confirm that the installation actually uses a physical boundary, guide or hybrid support wire.
3. Follow the model manual to isolate the station safely, then check station power and photograph the original terminal positions.
4. Inspect accessible connectors and known splices before tracing buried cable.
5. Narrow the suspect section using recent-work evidence, the manufacturer’s sectional method or a compatible wire-break detector.
6. Repair the complete damaged section with approved wire and weatherproof couplers, then verify the whole boundary, return path and docking cycle.

These are diagnostic stages, not universal wiring instructions. Terminal layouts, indicator meanings, resistance limits and isolation procedures vary by model and market.
