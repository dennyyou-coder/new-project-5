...
The official European pages describe [i2 LiDAR](https://navimow.segway.com/pages/navimow-i2-lidar-robot-lawn-mower) as using LiDAR and vision, with positioning that does not depend on satellites. The [i2 LiDAR Pro](https://navimow.segway.com/products/navimow-i2-lidar-pro-robot-lawn-mower) adds Network RTK to the LiDAR-and-vision combination. These configurations were checked on September 6, 2026.
