...
primary_brands: ["stihl", "makita"]
related_brands: ["bosch-power-tools", "craftsman", "kobalt", "skil", "hilti", "festool", "hikoki", "flex", "dremel", "metabo"]
author: "Denny You"
...
Metabo follows a different but equally relevant platform route through CAS, extending one documented 18V interface across participating professional brands. That alliance model makes exact tool, battery generation and market compatibility checks just as important as the brand name on the housing.
