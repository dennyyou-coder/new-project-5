---
title: "Who Owns Dyson? Does James Dyson Still Own Dyson?"
description: "Who owns Dyson? Sir James Dyson still controls the private company. See Dyson's parent-company structure, Singapore headquarters and manufacturing network."
date: "2026-07-18"
...
**Yes—Sir James Dyson still owns and ultimately controls Dyson.** The technology group remains privately held and family-owned; it is not owned by Apple, a Chinese company or public shareholders. Current UK company records identify Sir James as the only active person with significant control of Dyson UK Group Limited, with **75% or more** of its shares and voting rights and the right to appoint or remove directors.

**Who makes Dyson products?** Dyson develops products through its own group and manufactures advanced motors in its own facilities in Singapore and the Philippines, while also using external manufacturers and suppliers in a wider multi-country network. That group-level answer does not identify the legal manufacturer, assembly factory or country of origin for every vacuum, hair-care machine or floor cleaner, so the exact model still needs to be checked.
