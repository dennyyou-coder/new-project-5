---
title: "Who Owns Miele? Family Ownership, Origin and Factories"
description: "Who owns Miele? The Miele family holds 51% and the Zinkann family 49% of the private German appliance company. See its factories and structure."
date: "2026-07-18"
...
**Miele is privately owned by the Miele and Zinkann families, with the Miele family holding 51% and the Zinkann family 49%.** Miele's current official facts page states that this two-family ownership has existed since 1899. The group also says that roughly 80 family stakeholders are direct descendants of founders Carl Miele and Reinhard Zinkann. It is not a subsidiary of another appliance conglomerate, and it is not publicly traded.
...
|---|---|---|
| Miele and Zinkann families | Founding families that have owned Miele since 1899; current official split is 51% Miele family and 49% Zinkann family | The percentage held by each individual family member |
...
It does not mean the 80 stakeholders each own the same percentage. Miele publishes the current split between the two family groups, but not a current individual shareholder table. The family population, individual economic rights, voting arrangements and partnership interests are different questions.
...
Miele's current German [facts and figures page](https://www.miele.de/de/m/daten-und-fakten-323.htm) states that Miele & Cie. KG has been owned since 1899 by the Miele family at **51%** and the Zinkann family at **49%**. This is current first-party evidence, not merely a historical percentage carried forward from an old report.

The percentage describes the split between the two founding-family groups. It does not disclose the interest held by each of the roughly 80 individual family stakeholders, nor does it replace formal beneficial-ownership documentation for a legal transaction.

For a general company profile, the current official 51/49 split is the most direct answer. For legal due diligence, financing, a distribution agreement or an ownership declaration, the counterparty should still provide current registry extracts, partnership documentation or a signed beneficial-ownership statement.
...
Miele is a German company founded in 1899 and headquartered in Gütersloh. Its ownership and headquarters remain German, but its current manufacturing network includes plants in Germany and several other countries.

### Do the Miele and Zinkann families own 51% and 49%?

Yes. Miele's current official facts page states that the Miele family holds 51% and the Zinkann family 49%. The company does not publish the percentage held by each individual family stakeholder.
