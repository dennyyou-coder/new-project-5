...
2. **Does it have robotic lawn mower or outdoor robotics experience?**  
...
3. **Can it explain its navigation and boundary system clearly?**  
...
6. **Can it provide test data for slopes, terrain, grass height, obstacles, docking, rain exposure, and battery runtime?**  
   Ask for test methods, not only final claims.

7. **Can it support safety testing, blade system reliability, and waterproofing?**  
...
8. **Does it provide spare parts such as blades, wheels, batteries, charging docks, sensors, and covers?**  
   Spare parts are essential for long-term product support.
