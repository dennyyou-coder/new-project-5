...
featured: "false"
takeaways: ["Tineco is owned within Ecovacs Group: Ecovacs Robotics Co., Ltd.'s 2025 annual report identifies Tineco Intelligent Technology Co., Ltd. as a wholly owned subsidiary.", "ECOVACS ROBOTICS and Tineco are distinct consumer brands with different product roles, not two names for the same company.", "Tineco has group manufacturing capacity, but buyers should verify the legal manufacturer, factory and origin for each model from product and compliance documents."]
...
**Who makes Tineco products?** Tineco products are developed and manufactured through Ecovacs Group's Tineco operating structure. The 2025 annual report identifies Tineco Intelligent Technology Co., Ltd. as a principal R&D and manufacturing entity, and Tineco's [official history](https://us.tineco.com/about/) says its factory now covers more than 80,000 square metres. That proves in-group manufacturing capacity, not one universal factory for every vacuum or floor washer. For a specific model, the rating label, Declaration of Conformity, importer record and warranty documents remain the evidence for its legal manufacturer, factory and country of origin.
