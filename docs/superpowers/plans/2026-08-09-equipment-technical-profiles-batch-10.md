# Equipment Technical Profiles Batch Ten Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Publish three verified technical equipment pages for cordless stick vacuums, canister vacuum cleaners, and household robot vacuums.
...
- Work only in the isolated `codex/equipment-batch-10-20260809` branch.
...
### Task 1: Batch-ten release contract
...
Add literal expected slugs and technical-boundary phrases for `cordless-stick-vacuum`, `canister-vacuum-cleaner`, and `household-robot-vacuum`. Assert published status, valid schema, at least seven sources, six to eight representative models, at least four published brands, no component links, one official hero, two official content photos, one desktop/mobile WCB diagram pair, required image dimensions, and sitemap discovery.
...
**Files:**
- Create: `content/equipment/cordless-stick-vacuum.json`
- Create: `content/equipment/canister-vacuum-cleaner.json`
- Create: `content/equipment/household-robot-vacuum.json`
- Create: `public/images/equipment/cordless-stick-vacuum/*`
- Create: `public/images/equipment/canister-vacuum-cleaner/*`
- Create: `public/images/equipment/household-robot-vacuum/*`
