# Equipment Technical Profiles Batch Thirteen Implementation Plan

**Goal:** Publish three verified technical equipment pages for portable carpet and upholstery cleaners, electric pressure washers, and robotic pool skimmers.
...
- Work only in the isolated `codex/equipment-batch-13-20260809` branch.
...
## Task 1: Batch-thirteen release contract
...
- Create `content/equipment/portable-carpet-upholstery-cleaner.json` and its local visual package.
- Create `content/equipment/electric-pressure-washer.json` and its local visual package.
- Create `content/equipment/robotic-pool-skimmer.json` and its local visual package.
